...
from openapi_client.models.asset_search_space import AssetSearchSpace  # noqa: E501

class TestAssetSearchSpace(unittest.TestCase):
    """AssetSearchSpace unit test stubs"""
    ...
    def make_instance(self, include_optional) -> AssetSearchSpace:
        """Test AssetSearchSpace
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `AssetSearchSpace`
        """
        model = AssetSearchSpace()  # noqa: E501
        if include_optional:
