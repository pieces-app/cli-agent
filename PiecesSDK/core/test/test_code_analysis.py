...
from openapi_client.models.code_analysis import CodeAnalysis  # noqa: E501

class TestCodeAnalysis(unittest.TestCase):
    """CodeAnalysis unit test stubs"""
    ...
    def make_instance(self, include_optional) -> CodeAnalysis:
        """Test CodeAnalysis
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CodeAnalysis`
        """
        model = CodeAnalysis()  # noqa: E501
        if include_optional:
            return CodeAnalysis(
