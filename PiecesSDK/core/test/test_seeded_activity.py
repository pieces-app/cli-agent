...
from openapi_client.models.seeded_activity import SeededActivity  # noqa: E501

class TestSeededActivity(unittest.TestCase):
    """SeededActivity unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SeededActivity:
        """Test SeededActivity
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SeededActivity`
        """
        model = SeededActivity()  # noqa: E501
        if include_optional:
            return SeededActivity(
                ...
                user = openapi_client.models.referenced_user.ReferencedUser(
                    schema = openapi_client.models.embedded_model_schema.EmbeddedModelSchema(
                        migration = 56, 
                        semantic = 'MAJOR_0_MINOR_0_PATCH_1', ), 
