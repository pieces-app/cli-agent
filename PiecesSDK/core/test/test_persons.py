...
from openapi_client.models.persons import Persons  # noqa: E501

class TestPersons(unittest.TestCase):
    """Persons unit test stubs"""
    ...
    def make_instance(self, include_optional) -> Persons:
        """Test Persons
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `Persons`
        """
        model = Persons()  # noqa: E501
        if include_optional:
            return Persons(
