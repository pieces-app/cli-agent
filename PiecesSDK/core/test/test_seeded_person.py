...
from openapi_client.models.seeded_person import SeededPerson  # noqa: E501

class TestSeededPerson(unittest.TestCase):
    """SeededPerson unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SeededPerson:
        """Test SeededPerson
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SeededPerson`
        """
        model = SeededPerson()  # noqa: E501
        if include_optional:
            return SeededPerson(
