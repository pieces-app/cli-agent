...
from openapi_client.models.flattened_formats import FlattenedFormats  # noqa: E501

class TestFlattenedFormats(unittest.TestCase):
    """FlattenedFormats unit test stubs"""
    ...
    def make_instance(self, include_optional) -> FlattenedFormats:
        """Test FlattenedFormats
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `FlattenedFormats`
        """
        model = FlattenedFormats()  # noqa: E501
        if include_optional:
