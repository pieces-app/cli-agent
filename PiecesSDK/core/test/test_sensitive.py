...
from openapi_client.models.sensitive import Sensitive  # noqa: E501

class TestSensitive(unittest.TestCase):
    """Sensitive unit test stubs"""
    ...
    def make_instance(self, include_optional) -> Sensitive:
        """Test Sensitive
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `Sensitive`
        """
        model = Sensitive()  # noqa: E501
        if include_optional:
            return Sensitive(
