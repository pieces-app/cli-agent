...
from openapi_client.models.relevant_qgpt_seed import RelevantQGPTSeed  # noqa: E501

class TestRelevantQGPTSeed(unittest.TestCase):
    """RelevantQGPTSeed unit test stubs"""
    ...
    def make_instance(self, include_optional) -> RelevantQGPTSeed:
        """Test RelevantQGPTSeed
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `RelevantQGPTSeed`
        """
        model = RelevantQGPTSeed()  # noqa: E501
        if include_optional:
