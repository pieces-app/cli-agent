...
from openapi_client.models.distributions import Distributions  # noqa: E501
...
class TestDistributions(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> Distributions:
        """Test Distributions
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `Distributions`
        """
        model = Distributions()  # noqa: E501
        if include_optional:
