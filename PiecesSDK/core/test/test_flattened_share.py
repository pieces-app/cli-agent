...
from openapi_client.models.flattened_share import FlattenedShare  # noqa: E501

class TestFlattenedShare(unittest.TestCase):
    """FlattenedShare unit test stubs"""
    ...
    def make_instance(self, include_optional) -> FlattenedShare:
        """Test FlattenedShare
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `FlattenedShare`
        """
        model = FlattenedShare()  # noqa: E501
        if include_optional:
