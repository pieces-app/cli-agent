...
from openapi_client.models.flattened_anchor import FlattenedAnchor  # noqa: E501

class TestFlattenedAnchor(unittest.TestCase):
    """FlattenedAnchor unit test stubs"""
    ...
    def make_instance(self, include_optional) -> FlattenedAnchor:
        """Test FlattenedAnchor
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `FlattenedAnchor`
        """
        model = FlattenedAnchor()  # noqa: E501
        if include_optional:
