...
from openapi_client.models.reuse_suggestion import ReuseSuggestion  # noqa: E501

class TestReuseSuggestion(unittest.TestCase):
    """ReuseSuggestion unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ReuseSuggestion:
        """Test ReuseSuggestion
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ReuseSuggestion`
        """
        model = ReuseSuggestion()  # noqa: E501
        if include_optional:
