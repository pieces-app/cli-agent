...
from openapi_client.models.external_provider import ExternalProvider  # noqa: E501

class TestExternalProvider(unittest.TestCase):
    """ExternalProvider unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ExternalProvider:
        """Test ExternalProvider
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ExternalProvider`
        """
        model = ExternalProvider()  # noqa: E501
        if include_optional:
