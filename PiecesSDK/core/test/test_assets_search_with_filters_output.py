...
from openapi_client.models.assets_search_with_filters_output import AssetsSearchWithFiltersOutput  # noqa: E501

class TestAssetsSearchWithFiltersOutput(unittest.TestCase):
    """AssetsSearchWithFiltersOutput unit test stubs"""
    ...
    def make_instance(self, include_optional) -> AssetsSearchWithFiltersOutput:
        """Test AssetsSearchWithFiltersOutput
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `AssetsSearchWithFiltersOutput`
        """
        model = AssetsSearchWithFiltersOutput()  # noqa: E501
        if include_optional:
            return AssetsSearchWithFiltersOutput(
                var_schema = openapi_client.models.embedded_model_schema.EmbeddedModelSchema(
                    migration = 56, 
                    semantic = 'MAJOR_0_MINOR_0_PATCH_1', ),
                results = openapi_client.models.searched_assets.SearchedAssets(
                    schema = openapi_client.models.embedded_model_schema.EmbeddedModelSchema(
                        migration = 56, 
                        semantic = 'MAJOR_0_MINOR_0_PATCH_1', ), 
                    iterable = [
                        openapi_client.models.searched_asset.SearchedAsset(
    ...
    def testAssetsSearchWithFiltersOutput(self):
        """Test AssetsSearchWithFiltersOutput"""
