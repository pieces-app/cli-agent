...
from openapi_client.models.linkify import Linkify  # noqa: E501

class TestLinkify(unittest.TestCase):
    """Linkify unit test stubs"""
    ...
    def make_instance(self, include_optional) -> Linkify:
        """Test Linkify
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `Linkify`
        """
        model = Linkify()  # noqa: E501
        if include_optional:
            return Linkify(
                ...
                access = 'PUBLIC',
                distributions = openapi_client.models.seeded_distributions.SeededDistributions(
                    schema = openapi_client.models.embedded_model_schema.EmbeddedModelSchema(
                        migration = 56, 
                        semantic = 'MAJOR_0_MINOR_0_PATCH_1', ), 
                    iterable = [
