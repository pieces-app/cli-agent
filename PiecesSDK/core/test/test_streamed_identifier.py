...
from openapi_client.models.streamed_identifier import StreamedIdentifier  # noqa: E501

class TestStreamedIdentifier(unittest.TestCase):
    """StreamedIdentifier unit test stubs"""
    ...
    def make_instance(self, include_optional) -> StreamedIdentifier:
        """Test StreamedIdentifier
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `StreamedIdentifier`
        """
        model = StreamedIdentifier()  # noqa: E501
        if include_optional:
    ...
    def testStreamedIdentifier(self):
        """Test StreamedIdentifier"""
