...
from openapi_client.models.referenced_asset import ReferencedAsset  # noqa: E501

class TestReferencedAsset(unittest.TestCase):
    """ReferencedAsset unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ReferencedAsset:
        """Test ReferencedAsset
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ReferencedAsset`
        """
        model = ReferencedAsset()  # noqa: E501
        if include_optional:
