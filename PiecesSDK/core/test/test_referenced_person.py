...
from openapi_client.models.referenced_person import ReferencedPerson  # noqa: E501

class TestReferencedPerson(unittest.TestCase):
    """ReferencedPerson unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ReferencedPerson:
        """Test ReferencedPerson
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ReferencedPerson`
        """
        model = ReferencedPerson()  # noqa: E501
        if include_optional:
