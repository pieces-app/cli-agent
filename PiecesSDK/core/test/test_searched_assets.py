...
from openapi_client.models.searched_assets import SearchedAssets  # noqa: E501

class TestSearchedAssets(unittest.TestCase):
    """SearchedAssets unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SearchedAssets:
        """Test SearchedAssets
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SearchedAssets`
        """
        model = SearchedAssets()  # noqa: E501
        if include_optional:
