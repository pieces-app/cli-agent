...
from openapi_client.models.allocation_cloud import AllocationCloud  # noqa: E501

class TestAllocationCloud(unittest.TestCase):
    """AllocationCloud unit test stubs"""
    ...
    def make_instance(self, include_optional) -> AllocationCloud:
        """Test AllocationCloud
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `AllocationCloud`
        """
        model = AllocationCloud()  # noqa: E501
        if include_optional:
