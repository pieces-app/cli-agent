...
from openapi_client.models.existing_metadata import ExistingMetadata  # noqa: E501

class TestExistingMetadata(unittest.TestCase):
    """ExistingMetadata unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ExistingMetadata:
        """Test ExistingMetadata
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ExistingMetadata`
        """
        model = ExistingMetadata()  # noqa: E501
        if include_optional:
