...
from openapi_client.models.searched_asset import SearchedAsset  # noqa: E501

class TestSearchedAsset(unittest.TestCase):
    """SearchedAsset unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SearchedAsset:
        """Test SearchedAsset
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SearchedAsset`
        """
        model = SearchedAsset()  # noqa: E501
        if include_optional:
