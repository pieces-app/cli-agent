...
from openapi_client.models.flattened_person import FlattenedPerson  # noqa: E501

class TestFlattenedPerson(unittest.TestCase):
    """FlattenedPerson unit test stubs"""
    ...
    def make_instance(self, include_optional) -> FlattenedPerson:
        """Test FlattenedPerson
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `FlattenedPerson`
        """
        model = FlattenedPerson()  # noqa: E501
        if include_optional:
