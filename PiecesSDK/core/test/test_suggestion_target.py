...
from openapi_client.models.suggestion_target import SuggestionTarget  # noqa: E501

class TestSuggestionTarget(unittest.TestCase):
    """SuggestionTarget unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SuggestionTarget:
        """Test SuggestionTarget
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SuggestionTarget`
        """
        model = SuggestionTarget()  # noqa: E501
        if include_optional:
