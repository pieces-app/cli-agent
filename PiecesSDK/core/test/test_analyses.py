...
from openapi_client.models.analyses import Analyses  # noqa: E501
...
class TestAnalyses(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> Analyses:
        """Test Analyses
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `Analyses`
        """
        model = Analyses()  # noqa: E501
        if include_optional:
            return Analyses(
