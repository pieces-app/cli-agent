...
from openapi_client.models.flattened_tag import FlattenedTag  # noqa: E501

class TestFlattenedTag(unittest.TestCase):
    """FlattenedTag unit test stubs"""
    ...
    def make_instance(self, include_optional) -> FlattenedTag:
        """Test FlattenedTag
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `FlattenedTag`
        """
        model = FlattenedTag()  # noqa: E501
        if include_optional:
            return FlattenedTag(
