...
from openapi_client.models.returned_user_profile import ReturnedUserProfile  # noqa: E501

class TestReturnedUserProfile(unittest.TestCase):
    """ReturnedUserProfile unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ReturnedUserProfile:
        """Test ReturnedUserProfile
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ReturnedUserProfile`
        """
        model = ReturnedUserProfile()  # noqa: E501
        if include_optional:
    ...
    def testReturnedUserProfile(self):
        """Test ReturnedUserProfile"""
