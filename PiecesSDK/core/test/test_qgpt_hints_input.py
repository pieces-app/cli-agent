...
from openapi_client.models.qgpt_hints_input import QGPTHintsInput  # noqa: E501

class TestQGPTHintsInput(unittest.TestCase):
    """QGPTHintsInput unit test stubs"""
    ...
    def make_instance(self, include_optional) -> QGPTHintsInput:
        """Test QGPTHintsInput
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `QGPTHintsInput`
        """
        model = QGPTHintsInput()  # noqa: E501
        if include_optional:
            return QGPTHintsInput(
                query = '',
                answer = openapi_client.models.qgpt_question_answer.QGPTQuestionAnswer(
