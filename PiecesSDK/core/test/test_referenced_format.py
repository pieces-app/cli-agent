...
from openapi_client.models.referenced_format import ReferencedFormat  # noqa: E501

class TestReferencedFormat(unittest.TestCase):
    """ReferencedFormat unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ReferencedFormat:
        """Test ReferencedFormat
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ReferencedFormat`
        """
        model = ReferencedFormat()  # noqa: E501
        if include_optional:
