...
from openapi_client.models.flattened_website import FlattenedWebsite  # noqa: E501

class TestFlattenedWebsite(unittest.TestCase):
    """FlattenedWebsite unit test stubs"""
    ...
    def make_instance(self, include_optional) -> FlattenedWebsite:
        """Test FlattenedWebsite
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `FlattenedWebsite`
        """
        model = FlattenedWebsite()  # noqa: E501
        if include_optional:
