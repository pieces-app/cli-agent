...
from openapi_client.models.git_hub_distribution import GitHubDistribution  # noqa: E501

class TestGitHubDistribution(unittest.TestCase):
    """GitHubDistribution unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GitHubDistribution:
        """Test GitHubDistribution
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GitHubDistribution`
        """
        model = GitHubDistribution()  # noqa: E501
        if include_optional:
    ...
    def testGitHubDistribution(self):
        """Test GitHubDistribution"""
