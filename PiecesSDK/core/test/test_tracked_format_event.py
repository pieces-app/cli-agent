...
from openapi_client.models.tracked_format_event import TrackedFormatEvent  # noqa: E501

class TestTrackedFormatEvent(unittest.TestCase):
    """TrackedFormatEvent unit test stubs"""
    ...
    def make_instance(self, include_optional) -> TrackedFormatEvent:
        """Test TrackedFormatEvent
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `TrackedFormatEvent`
        """
        model = TrackedFormatEvent()  # noqa: E501
        if include_optional:
            return TrackedFormatEvent(
                var_schema = openapi_client.models.embedded_model_schema.EmbeddedModelSchema(
                    migration = 56, 
                    semantic = 'MAJOR_0_MINOR_0_PATCH_1', ),
                format = openapi_client.models.tracked_format.TrackedFormat(
    ...
    def testTrackedFormatEvent(self):
        """Test TrackedFormatEvent"""
