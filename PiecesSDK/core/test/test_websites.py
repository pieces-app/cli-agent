...
from openapi_client.models.websites import Websites  # noqa: E501

class TestWebsites(unittest.TestCase):
    """Websites unit test stubs"""
    ...
    def make_instance(self, include_optional) -> Websites:
        """Test Websites
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `Websites`
        """
        model = Websites()  # noqa: E501
        if include_optional:
            return Websites(
