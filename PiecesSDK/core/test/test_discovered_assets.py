...
from openapi_client.models.discovered_assets import DiscoveredAssets  # noqa: E501

class TestDiscoveredAssets(unittest.TestCase):
    """DiscoveredAssets unit test stubs"""
    ...
    def make_instance(self, include_optional) -> DiscoveredAssets:
        """Test DiscoveredAssets
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `DiscoveredAssets`
        """
        model = DiscoveredAssets()  # noqa: E501
        if include_optional:
