...
from openapi_client.models.sensitives import Sensitives  # noqa: E501

class TestSensitives(unittest.TestCase):
    """Sensitives unit test stubs"""
    ...
    def make_instance(self, include_optional) -> Sensitives:
        """Test Sensitives
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `Sensitives`
        """
        model = Sensitives()  # noqa: E501
        if include_optional:
            return Sensitives(
