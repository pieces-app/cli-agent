...
from openapi_client.models.tracked_session_event_identifier_description_pairs import TrackedSessionEventIdentifierDescriptionPairs  # noqa: E501

class TestTrackedSessionEventIdentifierDescriptionPairs(unittest.TestCase):
    """TrackedSessionEventIdentifierDescriptionPairs unit test stubs"""
    ...
    def make_instance(self, include_optional) -> TrackedSessionEventIdentifierDescriptionPairs:
        """Test TrackedSessionEventIdentifierDescriptionPairs
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `TrackedSessionEventIdentifierDescriptionPairs`
        """
        model = TrackedSessionEventIdentifierDescriptionPairs()  # noqa: E501
        if include_optional:
    ...
    def testTrackedSessionEventIdentifierDescriptionPairs(self):
        """Test TrackedSessionEventIdentifierDescriptionPairs"""
