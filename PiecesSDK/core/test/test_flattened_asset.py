...
from openapi_client.models.flattened_asset import FlattenedAsset  # noqa: E501

class TestFlattenedAsset(unittest.TestCase):
    """FlattenedAsset unit test stubs"""
    ...
    def make_instance(self, include_optional) -> FlattenedAsset:
        """Test FlattenedAsset
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `FlattenedAsset`
        """
        model = FlattenedAsset()  # noqa: E501
        if include_optional:
