...
from openapi_client.models.discovered_asset import DiscoveredAsset  # noqa: E501

class TestDiscoveredAsset(unittest.TestCase):
    """DiscoveredAsset unit test stubs"""
    ...
    def make_instance(self, include_optional) -> DiscoveredAsset:
        """Test DiscoveredAsset
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `DiscoveredAsset`
        """
        model = DiscoveredAsset()  # noqa: E501
        if include_optional:
