...
from openapi_client.models.flattened_assets import FlattenedAssets  # noqa: E501

class TestFlattenedAssets(unittest.TestCase):
    """FlattenedAssets unit test stubs"""
    ...
    def make_instance(self, include_optional) -> FlattenedAssets:
        """Test FlattenedAssets
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `FlattenedAssets`
        """
        model = FlattenedAssets()  # noqa: E501
        if include_optional:
