...
from openapi_client.models.person_model import PersonModel  # noqa: E501
...
class TestPersonModel(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> PersonModel:
        """Test PersonModel
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PersonModel`
        """
        model = PersonModel()  # noqa: E501
        if include_optional:
            return PersonModel(
