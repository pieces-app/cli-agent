...
from openapi_client.models.ocr_analysis import OCRAnalysis  # noqa: E501

class TestOCRAnalysis(unittest.TestCase):
    """OCRAnalysis unit test stubs"""
    ...
    def make_instance(self, include_optional) -> OCRAnalysis:
        """Test OCRAnalysis
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `OCRAnalysis`
        """
        model = OCRAnalysis()  # noqa: E501
        if include_optional:
            return OCRAnalysis(
