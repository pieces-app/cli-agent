...
[**associate_website**](AssetApi.md#associate_website) | **POST** /asset/{asset}/websites/associate/{website} | /asset/{asset}/websites/associate/{website} [POST]
[**disassociate_website**](AssetApi.md#disassociate_website) | **POST** /asset/{asset}/websites/disassociate/{website} | /asset/{asset}/websites/disassociate/{website} [POST]
...
# **associate_website**
> associate_website(asset, website)
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    try:
        # /asset/{asset}/websites/associate/{website} [POST]
        api_instance.associate_website(asset, website)
    except Exception as e:
        print("Exception when calling AssetApi->associate_website: %s\n" % e)
```
...
# **disassociate_website**
> disassociate_website(website, asset)
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    try:
        # /asset/{asset}/websites/disassociate/{website} [POST]
        api_instance.disassociate_website(website, asset)
    except Exception as e:
        print("Exception when calling AssetApi->disassociate_website: %s\n" % e)
```
