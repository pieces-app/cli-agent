...
class TestGitCommit(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.mock_get_repo_issues.return_value = [{'number': 1,'title': 'issue1',  'body': 'issue body'}]

        self.mock_get_issue_details = patch('pieces.autocommit.autocommit.get_issue_details').start()
        self.mock_get_issue_details.return_value = [v for _,v in self.mock_get_repo_issues.return_value[0].items()]
