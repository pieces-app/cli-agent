...
class TestHeadlessErrorScenarios:
    ...
    def test_interactive_operation_error_scenarios(self):
        ...
        test_cases = [
            ...
            ("user input", "Interactive operation user input cannot be performed in headless mode"),
            ("file selection", "Interactive operation file selection cannot be performed in headless mode"),
        ]
