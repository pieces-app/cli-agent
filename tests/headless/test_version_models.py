...
class TestVersionSuccess:
    ...
    def test_create_version_success_basic(self):
        ...
        response = create_version_success(
            cli_version="1.0.0", pieces_os_version="2.0.0"
        )
        ...
        expected_data = {"cli_version": "1.0.0", "pieces_os_version": "2.0.0"}
    ...
    def test_create_version_success_different_versions(self):
        ...
        for cli_version, pieces_os_version in test_cases:
            response = create_version_success(
                cli_version=cli_version, pieces_os_version=pieces_os_version
            )
    ...
    def test_create_version_success_semantic_versions(self):
        ...
        response = create_version_success(
            cli_version="1.2.3", pieces_os_version="2.4.6"
        )
    ...
    def test_create_version_success_prerelease_versions(self):
        ...
        response = create_version_success(
            cli_version="1.0.0-alpha.1", pieces_os_version="2.0.0-beta.2"
        )
    ...
    def test_create_version_success_build_metadata(self):
        ...
        response = create_version_success(
            cli_version="1.0.0+build.123", pieces_os_version="2.0.0+build.456"
        )
    ...
    def test_create_version_success_development_versions(self):
        ...
        response = create_version_success(
            cli_version="dev", pieces_os_version="nightly"
        )
    ...
    def test_create_version_success_empty_versions(self):
        ...
        response = create_version_success(cli_version="", pieces_os_version="")
    ...
    def test_create_version_success_mixed_versions(self):
        ...
        response = create_version_success(cli_version="1.2.3", pieces_os_version="dev")
    ...
    def test_create_version_success_to_dict(self):
        ...
        expected = {
            "success": True,
            "command": "version",
            "data": {"cli_version": "1.2.3", "pieces_os_version": "2.4.6"},
        }
    ...
    def test_create_version_success_unicode_versions(self):
        ...
        response = create_version_success(
            cli_version="1.0.0-测试", pieces_os_version="2.0.0-β"
        )
    ...
    def test_create_version_success_long_versions(self):
        ...
        response = create_version_success(
            cli_version=long_cli_version, pieces_os_version=long_pieces_os_version
        )
    ...
    def test_create_version_success_none_versions(self):
        ...
        response = create_version_success(cli_version=None, pieces_os_version=None)
    ...
    def test_create_version_success_mixed_none_values(self):
        ...
        response = create_version_success(cli_version="1.2.3", pieces_os_version=None)
    ...
    def test_create_version_success_parameter_types(self):
        ...
        response = create_version_success(
            cli_version=str(1.23), pieces_os_version=str(2.46)
        )
