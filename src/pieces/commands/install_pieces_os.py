...
def install_pieces_os(**kwargs):
    ...
    if Settings.pieces_client.local_os == "WINDOWS":
        install_command = (
            f'powershell.exe -Command "Add-AppxPackage -Appinstaller \"https://builds.pieces.app/stages/production/appinstaller/os_server.appinstaller?product={Settings.pieces_client.app_name}&download=true\" -ErrorAction Stop -Verbose ; '
