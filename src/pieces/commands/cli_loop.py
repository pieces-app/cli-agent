    ...
    def run_loop(cls):
        ...
        while Settings.run_in_loop:
            ...
            try:
                ...
                user_input = cls.session.prompt("User: ").strip()
                ...
                if user_input == 'exit':
                    ...
                    cls.assets_identifiers_ws.close_websocket_connection()  # Close using the assets_identifiers_ws instance
                    break
