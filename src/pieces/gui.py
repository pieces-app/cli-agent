...
def print_help():
    ...
    print("  --materials,-m    - Add a certain snippet or snippets using the index check list materials command to the ask command")
