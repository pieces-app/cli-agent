...
def print_help():
    ...
    print("  list_assets x   - Lists maximum of x number of assets")
    print("  list_apps       - List all registered applications")
    print("  list_models     - List all registered AI models")
    print()
