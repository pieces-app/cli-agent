...
def print_help():
    ...
    print("  remote            - Configure and manage remote execution settings")
    print("  remote setup      - Set up remote connection details")
    ...
    print("  remote test       - Test the remote connection with an optional command")
    print("  remote test \"ls\"   - Test the remote connection and execute \"ls\" command")
