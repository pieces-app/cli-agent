...
$packageArgs = @{
  ...
  softwareName  = 'pieces-cli*'  #part or all of the Display Name as you see it in Programs and Features. It should be enough to be unique
...
# Remove the tools directory from PATH
...
# @tsavo-at-pieces: should we redirect the user to a feedback page?
